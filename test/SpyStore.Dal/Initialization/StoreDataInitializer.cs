...
namespace SpyStore.Dal.Initialization
{
    public static class StoreDataInitializer
    {
        internal static void ResetIdentity(StoreContext context)
        {
            var tables = new [] 
            {
                "Categories", "Customers", "OrderDetails", "Orders", "Products",
                "ShoppingCartRecords"
            };
            ...
            foreach(var itm in tables)
            {
                ...
                #pragma warning disable EF1000 // Posible SQL injection vulnerability
        ...
        internal static void SeedData(StoreContext context)
        {
            try
            {
                ...
                if (!context.Customers.Any())
                {
                    ...
                    context.Customers.AddRange(SampleData.GetAllCustomerRecords(new List<Product> {
