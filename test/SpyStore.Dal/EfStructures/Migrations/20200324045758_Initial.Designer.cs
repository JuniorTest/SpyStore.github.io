...
namespace SpyStore.Dal.EfStructures.Migrations
{
    ...
    [Migration("20200324045758_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpyStore.Models.Entities.Base.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SpyStore.Models.Entities.ShoppingCardRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SpyStore.Models.Entities.Product", b =>
                {
                    b.HasOne("SpyStore.Models.Entities.Base.Category", "CategoryNavigation")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.OwnsOne("SpyStore.Models.Entities.Base.ProductDetail", "Details", b1 =>
                        {
                            ...
                            b1.HasOne("SpyStore.Models.Entities.Product")
                                .WithOne("Details")
                                .HasForeignKey("SpyStore.Models.Entities.Base.ProductDetail", "ProductId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
